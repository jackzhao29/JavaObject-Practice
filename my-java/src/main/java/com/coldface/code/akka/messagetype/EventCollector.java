...
/**
 * 类EventCollector.java的实现描述：TODO 类实现描述
 * 
 * @author coldface
 * @date 2016年7月17日上午10:06:27
 */
public class EventCollector extends ClusterRoleWorker {
  ...
  public void onReceive(Object message) throws Exception {
    ...
    if (message instanceof ClusterEvent.MemberUp) {
      ...
      // watch发送注册消息的interceptor，如果对于的actor终止了，会发送一个Terminated消息
      ...
      log.info(
          "Raw message:eventCode=" + eventCode + ", sourceHost=" + sourceHost + ", line=" + line);
      ...
      if (workers.size() > 0) {
        ...
        workers.get(interceptorIndex)
            .tell(new EventMessages.NginxRecord(sourceHost, line, eventCode), getSelf());
        log.info(
            "Details: interceptorIndex=" + interceptorIndex + ",interceptors=" + workers.size());
      }
    }
  }
